...
# from web_selenium.help.webdriver_manager import supported
...
class Settings(BaseSettings):
    ...
    base_url: str = 'https://art-gallery-rina-34213.web.app/'
    user_name: str = 'autotest_all'
    ...
    headless: bool = False
    window_width: int = 1500#1980
    window_height: int = 950#1200
